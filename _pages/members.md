...
<tr>
<td style="width: 30%;">{% include figure.html path="assets/img/LSRL.jpg" title="example image" width="200" height="200" class="img-fluid rounded z-depth-1" %}</td>
<td style="width: 70%;"><strong>Amir Hossein Ghasemi Farimani<br /></strong>Master&nbsp;student in energy and architecture&nbsp;(active now)<br />Research Topic:&nbsp;Photometry in architecture<br />Supervisor: Dr. N. Farahza /Advisor:&nbsp;Dr. M.&nbsp;Ali Haddad<br />Now @&nbsp;LSRL and&nbsp;Deprtment of&nbsp;Art and Architecture</td>
</tr>
<tr>
<td style="width: 30%;">&nbsp;{% include figure.html path="assets/img/LSRL.jpg" title="example image" width="200" height="200" class="img-fluid rounded z-depth-1" %}</td>
...
<tr>
<td style="width: 30%;">&nbsp;{% include figure.html path="assets/img/LSRL.jpg" title="example image" width="200" height="200" class="img-fluid rounded z-depth-1" %}</td>
<td style="width: 70%;"><strong>Morteza Karimi</strong><br />Master student in&nbsp;optics and laser Physics (Graduated:2023)<br />Research Topic:&nbsp;Solar cell fabrication<br />Supervisor:&nbsp;Prof. dr. A. Behjat /Advisor:&nbsp;Dr. M.Ali Haddad<br />Now @&nbsp;LSRL&nbsp;</td>
</tr>
<tr>
<td style="width: 30%;">{% include figure.html path="assets/img/LSRL.jpg" title="example image" width="200" height="200" class="img-fluid rounded z-depth-1" %}</td>
<td style="width: 70%;"><strong>Mohammad Reza Ahmadi</strong><br />Master student in&nbsp;meteorology&nbsp;(active now)<br />Research Topic: photometry in atmospheric science and&nbsp;meteorology<br />Supervisor: Dr. M. Joghataei/Advisor:&nbsp;Dr. M.Ali Haddad<br />Now @&nbsp;LSRL</td>
</tr>
<tr>
<td style="width: 30%;">{% include figure.html path="assets/img/LSRL.jpg" title="example image" width="200" height="200" class="img-fluid rounded z-depth-1" %}</td>
<td style="width: 70%;"><strong>Maryam Afshar</strong><br />Master&nbsp;student in atomic and&nbsp;molecular physics (Graduated:2022)<br />Research Topic: Nonlinear optical properties of quantum dots<br />Supervisor: Dr. M.Ali Haddad/Advisor: Dr. H. Zare<br />Email: <a href="mailto:maryamafshar1975@gmail.com">maryamafshar1975@gmail.com</a></td>
</tr>
<tr>
<td style="width: 30%;">{% include figure.html path="assets/img/LSRL.jpg" title="example image" width="200" height="200" class="img-fluid rounded z-depth-1" %}</td>
<td style="width: 70%;"><strong>Mohammad Javad Moradi</strong><br />Master&nbsp;student in atomic and&nbsp;molecular physics (Graduated:2022)<br />Supervisor:&nbsp;Dr. M.Ali Haddad /Advisor:&nbsp;Dr.&nbsp;F. Ostovari<br />Research Topic: Nonlinear optics</td>
</tr>
<tr>
...
<tr>
<td style="width: 30%;">{% include figure.html path="assets/img/LSRL.jpg" title="example image" width="200" height="200" class="img-fluid rounded z-depth-1" %}</td>
<td style="width: 70%;"><strong>Homa esmaeili</strong><br />Master&nbsp;student in Plasma Physics (Graduated:2019)<br />Supervisor:&nbsp;Dr. M. Sharifian/Advisor:Dr. M.Ali Haddad<br />Research Topic:&nbsp;Plasma</td>
</tr>
<tr>
<td style="width: 30%;">{% include figure.html path="assets/img/LSRL.jpg" title="example image" width="200" height="200" class="img-fluid rounded z-depth-1" %}</td>
<td style="width: 70%;"><strong>Elham Hoboubati</strong><br />Master&nbsp;student in atomic and&nbsp;molecular&nbsp;physics (Graduated:2018)<br />Supervisor: Dr. E. Gholamzadeh /Advisor:&nbsp;Dr. M.Ali Haddad<br />Research Topic: Dosimetry&nbsp;using optical fibers</td>
</tr>
<tr>
<td style="width: 30%;">{% include figure.html path="assets/img/LSRL.jpg" title="example image" width="200" height="200" class="img-fluid rounded z-depth-1" %}</td>
<td style="width: 70%;"><strong>Abolfazl Dehghan Banadaki</strong><br />Master&nbsp;student in atomic and molecular physics (Graduated:2018)<br />Supervisor: Dr. M.Ali Haddad /Advisor:&nbsp;Prof. dr. Abbas Behjat<br />Research Topic:&nbsp;Dynamic light scattering<br />Email: <a href="mailto:a.dehghan.banadaki@gmail.com">a.dehghan.banadaki@gmail.com</a></td>
</tr>
<tr>
...
<p>Ms. Fatemeh Ghadiri-Anari (Nonlinear opticala properties of Binary liquide edible oil)-(Project sponsered by National Foundation of Elites)-(active now)</p>
<p>Ms. Hamideh Beidmeshki (Nonlinear opticala properties of Binary liquide edible oil)-(Project sponsered by National Foundation of Elites)-(Graduated)</p>
